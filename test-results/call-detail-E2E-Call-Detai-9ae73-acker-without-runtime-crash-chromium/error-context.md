...
- Name: call-detail.spec.ts >> E2E Call Detail Experience >> 2. Processing call renders pipeline tracker without runtime crash
- Location: e2e\call-detail.spec.ts:16:3
...
Locator: getByText('support_onboarding_call.wav')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('support_onboarding_call.wav')
